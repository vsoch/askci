...
# This was developed on Ubuntu 18.04 LTS minimal on Google Cloud with 50GB disk
...
# docker run hello-world should then work!

if [ ! -d $INSTALL_ROOT/askci ]; then
    cd $INSTALL_ROOT

    # if you need to install a specific branch
    # git clone -b <branch> https://www.github.com/vsoch/askci.git

    # otherwise production
    git clone https://www.github.com/vsoch/askci.git
